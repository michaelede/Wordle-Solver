...
# print("You may optionally provide the secret word. Leave blank if you do not yet know it.")
# secret_word = input("Secret word: ").upper()
...
def conclusion(victory, round, secret_word):
 if victory == True:
   ...
   print(f"You did not complete the game within 6 rounds.")
