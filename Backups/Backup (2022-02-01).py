...
user = input("\nWhat is your name? ")  #Saved name for the text file
print("Valid Answers: ", len(validWords))  #Counts of Wordle entries
print("For Scoring:\n  Grey:    - or /\n  Green:   G or .\n  Yellow:  Y or ,")
...
guessRound = 0       #A tally of the number of rounds
...
def takeInput():
  ...
  return inputWord, inputScore, guesses, guessRound, greenLetters, yellow Letters
...
def frequency():
  ...
  wordString = ''.join(validSolutions)
  print(wordString)
